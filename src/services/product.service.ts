...
export class ProductService {
  ...
  async create({name, description, english_description, image, value, personCount, disponibility, lacFree, glutenFree, veg, categoryId}: CreateProductDto): Promise<CreatedProductDto> {
    try {
      const createProduct = this.productRepository.create({category:{id:categoryId}, name, description, english_description, image, value, personCount, disponibility, lacFree, glutenFree, veg});
